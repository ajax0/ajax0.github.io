...
(function () {
    ...
    class FBUBBLE extends HTMLElement {
        ...
        drawForceBubble(dataJSON, config, root, eventDispatcher) {
            ...
            var vis = container
                ...
                .style("height", config.showTitle || config.showSearch ? Math.max(container.style("height").replace("px", "") - 30, 125) + "px" : container.style("height"))
                .append("svg:svg")
                .attr("id", "svgContent")
                .attr("width", "100%")
                .attr("height", "100%");
                    ...
                    .on("click", function (d, i) {
                        ...
                        eventDispatcher.dispatchEvent(
                            new CustomEvent("propertiesChanged", {
                                detail: { properties: { selectedLabel: config.selectedLabel, selectedXValue: config.selectedXValue, selectedSizeValue: config.selectedSizeValue, selectedColorValue: config.selectedColorValue } },
                            })
                        );
    ...
    customElements.define("com-bcx-scatterplot", SCATTERPLOT);
})();