(function () {
        ...
        _submit(e) {
            ...
            this.dispatchEvent(
                new CustomEvent("propertiesChanged", {
                    detail: {
                        properties: { xAxisLabel: this.xAxisLabel, sizeLabel: this.sizeLabel, colorLabel: this.colorLabel, valDecimal: this.valDecimal, sizeDecimal: this.sizeDecimal, colorDecimal: this.colorDecimal, data: this.data },
                    },
                })
            );
        }
    ...
    customElements.define("com-bcx-scatterplot-bps", SCATTERPLOT_Bps);
})();
