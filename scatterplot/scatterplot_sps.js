(function () {
    ...
    class FBUBBLE_Sps extends HTMLElement {
        ...
        _submit(e) {
            e.preventDefault();
            this.dispatchEvent(new CustomEvent("propertiesChanged", { detail: { properties: { title: this.title, showTitle: this.showTitle, showAvg: this.showAvg, startColor: this.startColor, endColor: this.endColor } } }));
        }
        set title(newTitle) {
    ...
    customElements.define("com-bcx-scatterplot-sps", SCATTERPLOT_Sps);
})();